...
ARIMA model requires stationary, so this data need to check and transform it until this data is stationary.
...
In this plot, this data has trends and seasonal. So it needs to do the second step for stationary data
